  ...
  sliderDirective = function($timeout) {
    return {
      ...
      link: function(scope, element, attributes) {
        var barWidth, boundToInputs, ceilBub, cmbBub, dimensions, e, flrBub, fullBar, highBub, lowBub, maxOffset, maxPtr, maxValue, minOffset, minPtr, minValue, ngDocument, offsetRange, pointerHalfWidth, range, refHigh, refLow, selBar, selBub, updateDOM, valueRange, w, watchables, _i, _j, _len, _len1, _ref, _ref1;
