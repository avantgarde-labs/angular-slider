  ...
  sliderDirective = function($timeout) {
    return {
      ...
      link: function(scope, element, attributes) {
        var barWidth, boundToInputs, ceilBub, cmbBub, dimensions, e, flrBub, fullBar, highBub, lowBub, maxOffset, maxPtr, maxValue, minOffset, minPtr, minValue, ngDocument, offsetRange, pointerHalfWidth, range, refHigh, refLow, selBar, selBub, updateDOM, valueRange, watchables, _i, _len, _ref, _ref1;
        ...
        return updateDOM = function() {
          var adjustBubbles, bindToInputEvents, fitToBar, percentOffset, percentToOffset, percentValue, setBindings, setPointers, w, _j, _len1;
          dimensions();
          ...
          bindToInputEvents = function(pointer, ref, events) {
            ...
            onMove = function(event) {
              ...
              eventX = event.clientX || ((_ref2 = event.touches) != null ? (_ref3 = _ref2[0]) != null ? _ref3.clientX : void 0 : void 0);
